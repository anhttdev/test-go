...
func (rs *RoleService) ConvertDTOToModel(input *dto.CreateRoleInput) *model2.Role {
	return &model2.Role{
...
// Lấy tất cả các Role
func (rs *RoleService) GetAllRoles() ([]model2.Role, error) {
