...
func (ur *SQLUserRepository) FindUserAndAccountByUserId(userWithAcc *dto2.UserWithAccount, id int) error {
...
func (ur *SQLUserRepository) CheckUnique(registerInput dto2.RegisterInput) map[string]string {
...
func (ur *SQLUserRepository) GetUserWithCusor(request dto2.CursorPagingUser) ([]model.User, dto2.PagingInfo, error) {
	limit := request.Limit
	...
	if err := query.Find(&users).Error; err != nil {
		return nil, dto2.PagingInfo{}, err
	}
...
func (ur *SQLUserRepository) ConvertUserToResponse(user model.User) dto2.Response {
	userDTO := dto2.ConvertUserToResponse(user)
	response := dto2.NewSuccessResponse(
...
func (ur *SQLUserRepository) CheckUserUnique(registerInput dto2.RegisterAccountInput) []string {
